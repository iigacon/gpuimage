...
LOCAL_SRC_FILES :=  \
			...
			$(CGE_SOURCE)/filters/cgeSquareFrame.cpp \
            $(CGE_SOURCE)/filters/cgeDoubleFilter.cpp \
			$(CGE_SOURCE)/filters/cgeQuadFilter.cpp \
			$(CGE_SOURCE)/filters/cgeQuadFlipFilter.cpp \
			$(CGE_SOURCE)/filters/cgeHexaFilter.cpp \
			$(CGE_SOURCE)/filters/cgeHeartFilter.cpp \
			$(CGE_SOURCE)/filters/cgeZoomFilter.cpp \
			$(CGE_SOURCE)/filters/cgeTripleFilter.cpp \
			\
