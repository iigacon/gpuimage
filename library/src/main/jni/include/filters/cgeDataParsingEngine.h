...
namespace CGE
{
	...
	public:
		...
		static CGEImageFilterInterface* squareParser(const char* pstr, CGEMutipleEffectFilter* fatherFilter = nullptr);
        static CGEImageFilterInterface* doubleParser(const char* pstr, CGEMutipleEffectFilter* fatherFilter = nullptr);
		static CGEImageFilterInterface* hexaParser(const char* pstr, CGEMutipleEffectFilter* fatherFilter = nullptr);
		static CGEImageFilterInterface* quadParser(const char* pstr, CGEMutipleEffectFilter* fatherFilter = nullptr);
		static CGEImageFilterInterface* quadFlipParser(const char* pstr, CGEMutipleEffectFilter* fatherFilter = nullptr);
		static CGEImageFilterInterface* heartParser(const char* pstr, CGEMutipleEffectFilter* fatherFilter = nullptr);
		static CGEImageFilterInterface* zoomParser(const char* pstr, CGEMutipleEffectFilter* fatherFilter = nullptr);
		static CGEImageFilterInterface* tripleParser(const char* pstr, CGEMutipleEffectFilter* fatherFilter = nullptr);
	};
