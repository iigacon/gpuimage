...
do{\
	...
	CGEImageFilterInterface* CGEDataParsingEngine::squareParser(const char* pstr, CGEMutipleEffectFilter* fatherFilter)
	{
        CGESquareFilter* proc = new CGESquareFilter;
        if(!proc->init())
        {
            delete proc;
            return nullptr;
	...
	CGEImageFilterInterface* CGEDataParsingEngine::doubleParser(const char* pstr, CGEMutipleEffectFilter* fatherFilter)
	{
        CGEDoubleFilter* proc = new CGEDoubleFilter;
        if(!proc->init())
        {
            delete proc;
            return nullptr;
	...
	CGEImageFilterInterface* CGEDataParsingEngine::hexaParser(const char* pstr, CGEMutipleEffectFilter* fatherFilter)
	{
        CGEHexaFilter* proc = new CGEHexaFilter;
        if(!proc->init())
        {
            delete proc;
            return nullptr;
	...
	CGEImageFilterInterface* CGEDataParsingEngine::quadParser(const char* pstr, CGEMutipleEffectFilter* fatherFilter)
	{
        CGEQuadFilter* proc = new CGEQuadFilter;
        if(!proc->init())
        {
            delete proc;
            return nullptr;
	...
	CGEImageFilterInterface* CGEDataParsingEngine::quadFlipParser(const char* pstr, CGEMutipleEffectFilter* fatherFilter)
	{
        CGEQuadFlipFilter* proc = new CGEQuadFlipFilter;
        if(!proc->init())
        {
            delete proc;
            return nullptr;
	...
	CGEImageFilterInterface* CGEDataParsingEngine::zoomParser(const char* pstr, CGEMutipleEffectFilter* fatherFilter)
	{
        CGEImageFilterInterface* proc = nullptr;
        float intensity, base;
        int argNum;
        ...
        if(filter != nullptr)
        {
            ...
            if(argNum == 2)
            {
                filter->setBlurLevel(intensity * CGEZoomFilter::MAX_LERP_BLUR_INTENSITY);
                filter->setMipmapBase(base);
            }
            else
            {
    ...
    CGEImageFilterInterface* CGEDataParsingEngine::tripleParser(const char* pstr, CGEMutipleEffectFilter* fatherFilter)
	{
        CGEImageFilterInterface* proc = nullptr;
       float intensity, base;
       int argNum;
       ...
       auto* filter = createTripleFilter();
       ...
       if(filter != nullptr)
       {
           ...
           if(argNum == 2)
           {
               filter->setBlurLevel(intensity * CGETripleFilter::MAX_LERP_BLUR_INTENSITY);
               filter->setMipmapBase(base);
           }
           else
           {
